...
let conf = {
  ...
  appendStats: "/home/grigoriosntousakis/lya/core/tst/micro-packages/periods/stats.txt",
  debug: true,
  context: {
    excludes: ['Promise', 'toString', 'escape', 'setImmediate'],
  },
  modules: {
    include: [require.resolve("./_periods.js")]
  },
  printResults: true,
};
lya.configRequire(require, conf);
module.exports = require("./_periods.js");
