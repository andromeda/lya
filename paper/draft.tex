...
%  from \sys and confirm it does not affect the correctness of the program with respect to its sequential execution.
...
% We use two broad classes of micro-benchmarks.
% In the first class, we use the same 50 libraries that were the focus of a previous section~\sx{meso} to understand the characteristics of access patterns and \sys-internal overheads in a controlled environment.
% In the second class, we use synthetic micro-benchmarks to test key properties of each analysis and confirm it outputs the expected results.
