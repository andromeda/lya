...
This paper introduces \emph{module dialysis}, a novel technique for dynamic analysis specifically tailored to module boundaries. % to applications with many modules
Modules are becoming the cornerstone of modern software engineering:
  applications today use hundreds of modules, to the point where code written by their nominal developers is becoming only a small fraction of their total line count.
On the surface, such code reuse is beneficial, as it lowers development costs, software testing, encapsulation; 
  however, such over-reliance creates many challenges later in the development process, exactly because developers have little knowledge and understanding of module's internals.
...
% Turn such over-reliance on its head
To address these challenges, module dialysis enables dynamic fragmentation, analysis, and re-assembly of applications at the level of individual modules.
